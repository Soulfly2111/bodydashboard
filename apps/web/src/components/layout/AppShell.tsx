import { Activity, Apple, CalendarDays, Camera, Droplet, Dumbbell, Home, Images, Menu, Moon, Scale, Settings, Shield, Soup, Sun } from "lucide-react";
...
const nav = [
  ...
  { id: "bodyProgress", to: "/body-progress", label: "Körperfortschritt", icon: Images },
