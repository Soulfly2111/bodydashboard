...
Der Produktionsprozess für [`Soulfly2111/bodydashboard`](https://github.com/Soulfly2111/bodydashboard), `bodydashboard.de` und den Webroot `/etc/www/bodydashboard` liegt in [DEPLOYMENT.md](./DEPLOYMENT.md). Enthalten sind GitHub Actions, Server-Bootstrap, systemd-Service und Apache-Reverse-Proxy-Konfiguration.
